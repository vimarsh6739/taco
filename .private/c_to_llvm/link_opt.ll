...
entry:
  ...
  %call = call i32 (i32, i32, ...) bitcast (i32 (i32, i32)* @Sum to i32 (i32, i32, ...)*)(i32 %0, i32 %1)
  store i32 %call, i32* %c, align 4
  %2 = load i32, i32* %a, align 4
  %3 = load i32, i32* %b, align 4
  %4 = load i32, i32* %c, align 4
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0), i32 %2, i32 %3, i32 %4)
  ret i32 0
}
...
define i32 @Sum(i32 %a, i32 %b) local_unnamed_addr #2 {
  %c = add i32 %b, %a
  ret i32 %c
}
...
attributes #2 = { alwaysinline mustprogress nofree norecurse nosync nounwind readnone willreturn }
